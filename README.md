...
1. Fork/clone this repository from GitHub.
 ...
 ```shell
 git clone https://github.com/OpenLMIS/lesotho-equipment.git <openlmis-your-service-name>
 ```
2. Respectively change all instances of `lesotho-equipment` and
`equipment` within the project to `openlmis-your-service-name` and
`your-service-name`.
...
```shell
> docker-compose -f docker-compose.builder.yml run --service-ports equipment
```
